...
Branch ini berisi 6 error yang umum ditemukan pada project Laravel.
...
Setiap langkah akan menampilkan error. Setelah fix error, ulangi
aksi yang sama. Jika berhasil, lanjutkan ke langkah berikutnya.
